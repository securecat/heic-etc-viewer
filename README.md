...
- Images: HEIC/HEIF, JPEG, PNG, WebP, GIF, AVIF, SVG, BMP, TIFF, ICO
- Videos: MP4, WebM, MOV
- Documents: PDF
...
**[HeV Sender](chrome-extension/README.md)** is a Chrome extension that collects images, videos, and PDFs from the page you are viewing and sends them to HEIC etc Viewer. See its own README for details.
...
- 画像：HEIC/HEIF、JPEG、PNG、WebP、GIF、AVIF、SVG、BMP、TIFF、ICO
- 動画：MP4、WebM、MOV
- ドキュメント：PDF
...
**[HeV Sender](chrome-extension/README.md)** は、表示中のページの画像・動画・PDFを収集して HEIC etc Viewer へ送出するChrome拡張です。詳細は拡張側のREADMEを参照してください。
